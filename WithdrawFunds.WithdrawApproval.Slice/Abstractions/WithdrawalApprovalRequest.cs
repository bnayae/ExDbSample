...
/// <param name="EffectiveAccountBalance">The effective account balance (actual balance - the approved in progress withdrawal)</param>
public record WithdrawalApprovalRequest(AccountId AccountId,
                                        FundsTransactionData Data,
                                        FundsInitiateMethod InitiateMethod,
                                        double EffectiveAccountBalance);